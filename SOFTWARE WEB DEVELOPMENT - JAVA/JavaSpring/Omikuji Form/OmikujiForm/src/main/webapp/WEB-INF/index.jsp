                    ...
                    <div class="card p-5">
                        <form action="/send" method="POST">
                            ...
                            <div class="form-group my-2">
                                ...
                                <input type="text" class="form-control" name="job" id="exampleInputEmail1">
                            </div>
                            <div class="form-group my-2">
                            ...
                            <div class="form-group my-2">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="something"rows="3"></textarea>
                            </div>
                            <small id="passwordHelpBlock" class="form-text text-muted">
                                Send and show a friend
                            </small><br>
                            <input type="submit" class="btn btn-primary" value="Send" name="go">
                        </form>
                    </div>
                </div>
            </div>
